  ...
  return (
    <>
      ...
      >
        ...
        >
          <img src={logoBrown} alt="vbs logo" className="w-17 xl:w-26 h-auto" />
          <Box>
        ...
        >
          ...
          <Typography align="left">
            Check-in / Check-out:{" "}
            {guest?.checkIn ? dayjs(guest.checkIn).format("DD/MM/YYYY") : ""} to{" "}
            {guest?.checkOut ? dayjs(guest.checkOut).format("DD/MM/YYYY") : ""}
          </Typography>
